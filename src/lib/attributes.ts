export interface AttributeDefinition {
  ...
  defaultValue?: string;
  options?: string[];
  engines?: string[]; // If undefined, applies to all engines
}
...
export const GRAPHVIZ_ATTRIBUTES: AttributeDefinition[] = [
  ...
  { key: 'fontname', label: 'Font Name', description: 'Font used for text', type: 'all', valueType: 'select', options: ['League Spartan', 'League Gothic', 'League Script', 'Raleway', 'Linden Hill', 'Fanwood Text', 'Goudy Bookletter 1911', 'Sorts Mill Goudy', 'Apfel Grotezk', 'Ribes', 'Ortica', 'Mattone', 'Sprat', 'Coconat', 'Messapia', 'Necto Mono'] },
  ...
  // Node Attributes
  { key: 'shape', label: 'Shape', description: 'The shape of the node', type: 'node', valueType: 'select', options: ['box', 'circle', 'ellipse', 'diamond', 'none', 'plaintext', 'record', 'Mrecord', 'polygon', 'cylinder', 'note', 'tab', 'folder', 'box3d', 'component'] },
  ...
  { key: 'pos', label: 'Position', description: 'Position of node (x,y)', type: 'node', valueType: 'text', engines: ['neato', 'fdp', 'sfdp', 'twopi', 'circo'] },
  ...
  { key: 'len', label: 'Length', description: 'Preferred length of the edge', type: 'edge', valueType: 'number', engines: ['neato', 'fdp', 'sfdp'] },
  ...
  { key: 'constraint', label: 'Constraint', description: 'If false, edge is not used in rank assignment', type: 'edge', valueType: 'boolean', engines: ['dot'] },
  { key: 'minlen', label: 'Min Length', description: 'Minimum distance between nodes', type: 'edge', valueType: 'number', engines: ['dot'] },
  ...
  { key: 'labelfontname', label: 'Label Font Name', description: 'Font for head/tail labels', type: 'edge', valueType: 'select', options: ['League Spartan', 'League Gothic', 'League Script', 'Raleway', 'Linden Hill', 'Fanwood Text', 'Goudy Bookletter 1911', 'Sorts Mill Goudy', 'Apfel Grotezk', 'Ribes', 'Ortica', 'Mattone', 'Sprat', 'Coconat', 'Messapia', 'Necto Mono'] },
  { key: 'labelfontsize', label: 'Label Font Size', description: 'Font size for head/tail labels', type: 'edge', valueType: 'number' },
  { key: 'headport', label: 'Head Port', description: 'Where on the node the edge attaches', type: 'edge', valueType: 'select', options: ['n', 'ne', 'e', 'se', 's', 'sw', 'w', 'nw', 'c', '_'] },
  { key: 'tailport', label: 'Tail Port', description: 'Where on the node the edge starts', type: 'edge', valueType: 'select', options: ['n', 'ne', 'e', 'se', 's', 'sw', 'w', 'nw', 'c', '_'] },
  
  // Graph Attributes
  { key: 'rankdir', label: 'Rank Direction', description: 'Direction of layout', type: 'graph', valueType: 'select', options: ['TB', 'BT', 'LR', 'RL'], engines: ['dot'] },
  { key: 'nodesep', label: 'Node Separation', description: 'Minimum space between nodes in same rank', type: 'graph', valueType: 'number' },
  { key: 'ranksep', label: 'Rank Separation', description: 'Minimum space between ranks', type: 'graph', valueType: 'number', engines: ['dot', 'twopi'] },
  ...
  { key: 'overlap', label: 'Overlap', description: 'How to handle node overlaps', type: 'graph', valueType: 'select', options: ['true', 'false', 'scale', 'prism'], engines: ['neato', 'fdp', 'sfdp', 'twopi', 'circo'] },
  ...
  { key: 'compound', label: 'Compound', description: 'Allow edges between clusters', type: 'graph', valueType: 'boolean', engines: ['dot'] },
  { key: 'concentrate', label: 'Concentrate', description: 'Merge multi-edges', type: 'graph', valueType: 'boolean', engines: ['dot'] },
  ...
  { key: 'ordering', label: 'Ordering', description: 'Order of edges out of a node', type: 'graph', valueType: 'select', options: ['out'], engines: ['dot'] },
  { key: 'rank', label: 'Rank', description: 'Rank constraints on nodes', type: 'graph', valueType: 'select', options: ['same', 'min', 'source', 'max', 'sink'], engines: ['dot'] },
  { key: 'newrank', label: 'New Rank', description: 'Use new rank algorithm', type: 'graph', valueType: 'boolean', engines: ['dot'] },
