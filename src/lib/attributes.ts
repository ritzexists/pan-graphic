...
export const GRAPHVIZ_ATTRIBUTES: AttributeDefinition[] = [
  ...
  { key: 'fontname', label: 'Font Name', description: 'Font used for text', type: 'all', valueType: 'select', options: ['Arial', 'Helvetica', 'Times-Roman', 'Courier', 'Verdana', 'Georgia', 'Palatino', 'Garamond', 'Bookman', 'Comic Sans MS', 'Trebuchet MS', 'Arial Black', 'Impact', 'Inter', 'JetBrains Mono'] },
  ...
  { key: 'labelfontname', label: 'Label Font Name', description: 'Font for head/tail labels', type: 'edge', valueType: 'select', options: ['Arial', 'Helvetica', 'Times-Roman', 'Courier', 'Verdana', 'Georgia', 'Palatino', 'Garamond', 'Bookman', 'Comic Sans MS', 'Trebuchet MS', 'Arial Black', 'Impact', 'Inter', 'JetBrains Mono'] },
